...
<body>
	...
	<div id="container">
		...
		<form:form action="updateSmartphone" modelAttribute="smartphone" method="POST"> 
				...
				<tr>
					...
					<td>
						<form:select path="manufacturerId">
							...
							<form:option value="${smartphone.manufacturer.id}"><c:out value="${smartphone.manufacturer.brandName}"></c:out></form:option>
